...
CREATE TABLE pop_ct_1971 AS (
	...
	coalesce(sum(in_1971_ea_jct.pop::integer),0) AS ct_pop,
	coalesce(sum(in_1971_ea_jct.hhlds::integer),0) AS ct_dwe
	FROM in_1971_ea_jct
	LEFT JOIN in_1976_cbf_ct ON in_1971_ea_jct.ctuid = in_1976_cbf_ct.geosid
